...
for (i in 1:5) {
  ...
  tabla$P95_max <-  confint(model_g, "Año", level = .95)[, 2]
  tabla$P95_min <-  confint(model_g, "Año", level = .95)[, 1]
  ...
  if (nrow(ind) > 10) {
    for (i in 1:5) {
      tryCatch({
        ...
        tabla$P95_max <-  confint(model_i, "Año", level = .95)[, 2]
        tabla$P95_min <-  confint(model_i, "Año", level = .95)[, 1]
